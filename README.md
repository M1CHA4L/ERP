...
1. 将制版订单改为“订单主信息 + 版辊参数 + 色组明细”，支持新版、旧版、退镀、返工和历史复制。
2. 打通生产通知表、车间任务单、收据、客户账单四类核心打印。
3. 财务改为日收入登记，并按客户、版号、月份汇总已收和待结款。
4. 增加库存入库、领料、版辊入库和客户来料优先调用。
5. 增加销售月成绩、客户月销售额、日收入表、对账汇总表。
