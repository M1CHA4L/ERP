...
const dictionary: Record<string, TranslationValue> = {
  ...
  'nav.productionBoard': { zh: '工序看板', en: 'Process Board' },
  'nav.workflowV2': { zh: '订单进度', en: 'Order Progress' },
  'nav.myTasks': { zh: '工序任务', en: 'Step Tasks' },
  ...
  'common.noFlowAccess': { zh: '当前岗位没有订单进度入口', en: 'No order progress entry for this role' },
